    ...
    public class LoggingMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, IUnitOfWork unitOfWork)
        {
            ...
            else
            {
                ...
                //await LogResponse(context, auditLog, unitOfWork);
            }
        }
        ...
        //public async Task LogResponse(HttpContext context, AuditLog auditLog, IUnitOfWork unitOfWork)
        //{
        //    if (auditLog == null)
        //    {
        //        await _next(context);
        ...
        //        Form = form != null ? Newtonsoft.Json.JsonConvert.SerializeObject(form) : ""
        //    };
        //    return log;
        //}
    }
